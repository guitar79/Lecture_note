...
\RequirePackage{xetexko}
	...
	\setmainhangulfont[BoldFont=*,BoldFeatures=FakeBold,ItalicFont=*,ItalicFeatures=FakeSlant]{NanumMyeongjo}
%\RequirePackage{xetexko}
...
\captionsetup[figure]{%
	font=footnotesize,labelsep=period,singlelinecheck=off,aboveskip=0pt,% 
	belowskip=5pt, margin=0pt,subrefformat=parens%
}
\captionsetup[table]{%
	font=footnotesize,labelsep=period,singlelinecheck=off,aboveskip=5pt,% 
	margin=0pt%
}
...
\usepackage[top=3.0cm,bottom=3.0cm,left=3.0cm,right=3.0cm,headsep=10pt,a4paper]{geometry} % Page margins
